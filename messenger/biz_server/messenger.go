...
import (
	...
	"github.com/fedigram/fedigram-server/messenger/biz_server/server/account"
	"github.com/fedigram/fedigram-server/messenger/biz_server/server/auth"
	"github.com/fedigram/fedigram-server/messenger/biz_server/server/bots"
	"github.com/fedigram/fedigram-server/messenger/biz_server/server/channels"
	"github.com/fedigram/fedigram-server/messenger/biz_server/server/contacts"
	"github.com/fedigram/fedigram-server/messenger/biz_server/server/help"
	"github.com/fedigram/fedigram-server/messenger/biz_server/server/langpack"
	"github.com/fedigram/fedigram-server/messenger/biz_server/server/messages"
	"github.com/fedigram/fedigram-server/messenger/biz_server/server/payments"
	"github.com/fedigram/fedigram-server/messenger/biz_server/server/phone"
	"github.com/fedigram/fedigram-server/messenger/biz_server/server/photos"
	"github.com/fedigram/fedigram-server/messenger/biz_server/server/stickers"
	"github.com/fedigram/fedigram-server/messenger/biz_server/server/updates"
	"github.com/fedigram/fedigram-server/messenger/biz_server/server/users"
	...
	// "github.com/fedigram/fedigram-server/service/bots/client"
)
